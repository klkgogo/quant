...
class StrateBase(object):
    ...
    def init_strate(self, quant_frame, event_engine=None):
    ...
    def get_logger(self ):
        file_path = '~/vt_' + datetime.now().strftime('%Y%m%d') + '.log'
